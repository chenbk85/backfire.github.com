...
function! <SID>DoxygenAuthorFunc()
  ...
  exec "normal o".s:interCommentTag."Modify $Date: $"
  exec "normal o".s:interCommentTag."Modify $Author: $"
  exec "normal o".s:interCommentTag."Copyright: TaoMee, Inc. ShangHai CN. All rights reserved."
