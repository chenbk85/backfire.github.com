...
\begin{itemize}
    \item {\bf 运维系统}，C/C++ 高级开发工程师 
        ...
        本人领导三个人的小团队，全面负责运维系统的后台研发工作。
        期间，辅导一名应届生顺利转正。
        在后台架构上，使用了统一的异步服务器框架，
        并指导团队成员快速构建具有集中分发、透明代理等模块的多层次网络架构。
        \\
    \item {\bf 射击类竞技页游《凯特战争》}，C/C++ 后台开发工程师 
        \hfill 2011年11月 - 2012年6月\\[1mm]
        《凯特战争》是淘米首款采用与WOW类似的大区小服结构的页游。
...
\begin{itemize}
    ...
    \item 掌握C/C++，十万行以上代码经验，熟悉Shell编程，对Python和PHP编程有一定的了解
